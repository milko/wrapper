...
/**
 * ISO_3166_2_Iterator.php
 *
 * This file contains the definition of the {@link ISO_3166_2_Iterator} class.
 */
...
/**
 * <h4>ISO 3166-2 codes iterator.</h4><p />
 *
 * This is a <em>concrete</em> implementation of the {@link ISOCodesIterator} class, it will
 * iterate and translate the ISO 3166-2 standard.
 *
 * You instantiate this class by calling the
 * <tt>ISOCodes::getIterator( ISOCodes::k3166_2 )</tt> method.
 *
 *	@package	Utils
 *
 ...
 *	@since		26/08/2016
 */
class ISO_3166_2_Iterator extends ISOCodesIterator
{
 ...
 *======================================================================================*/
	 ...
	 *
	 * We implement this method by returning the <tt>code</tt> property name.
	 *
